...
protected:
   ...
   mutable Vector blocks;
   mutable Vector blocks_for_lumping;
   mutable DenseTensor tensor;
...
public:
   ...
   //Call after setup
   void LumpMatrix(Vector &Ml) const; 

   void CopyElemMass(Vector &Me) const; 
